...
module.exports = {
  ...
  keymaps: {
    ...
    "pane:next": "cmd+pageup",
    "pane:prev": "cmd+pagedown",
    "pane:splitRight": "cmd+shift+e",
    "pane:splitDown": "cmd+shift+d",
    "pane:close": "cmd+shift+w",
    "editor:undo": "cmd+shift+z",
    "editor:redo": "cmd+shift+y",
    "editor:cut": "cmd+shift+x",
    "editor:copy": "cmd+shift+c",
    "editor:paste": "cmd+shift+v",
    "editor:selectAll": "cmd+shift+a",
    "editor:search": "cmd+shift+f",
